    ...
    public void Rebalanceo_Hoja(int _K) {
        ...
        try {
            ...
            if (this.getHijos()[_K].getK() < 2 && this.getHijos()[_K + 1].getK() > 2) {
                ...
                this.getHijos()[_K].getHijos()[this.getHijos()[_K].getK()] = this.getHijos()[_K + 1].getHijos()[0];

                for (int i = 0; i < this.getHijos()[_K + 1].getK(); i++) {
                    this.getHijos()[_K + 1].getLlave()[i] = this.getHijos()[_K + 1].getLlave()[i + 1];
                    this.getHijos()[_K + 1].getHijos()[i] = this.getHijos()[_K + 1].getHijos()[i + 1];
                }
...
//                }
        ...
        try {
            ...
            if (this.getHijos()[_K].getK() < 2 && this.getHijos()[_K - 1].getK() > 2) {
                ...
                this.getHijos()[_K - 1].getHijos()[this.getHijos()[_K - 1].getK()] = this.getHijos()[_K].getHijos()[this.getHijos()[_K].getK()];

                for (int k = _K; k < this.getK(); k++) {
                    this.getLlave()[k - 1] = this.getLlave()[k];
                    this.getHijos()[k + 1] = this.getHijos()[k + 2];
                }
                this.setK(this.getK() - 1);
